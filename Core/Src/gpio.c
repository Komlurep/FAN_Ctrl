...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(FANSW_GPIO_Port, FANSW_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : FANSW_Pin */
  GPIO_InitStruct.Pin = FANSW_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(FANSW_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : SER_Pin DISEN_Pin A1_Pin A2_Pin */
  ...
  /*Configure GPIO pins : DISLK_Pin SCK_Pin A3_Pin A0_Pin */
